...
var (
	...
	ErrSteveNotConfigured          = errors.New("kubernetes client not configured, please configure Rancher credentials or kubeconfig paths to use this tool")
	ErrClusterSourcesNotConfigured = errors.New("no cluster source is configured, please configure Rancher credentials or kubeconfig paths")
